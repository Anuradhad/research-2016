...
static SwigV8ReturnValue _wrap_Segment_fromIter(const SwigV8Arguments &args) {
  ...
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_ps_seg_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static SwigV8ReturnValue _wrap_NBest_fromIter(const SwigV8Arguments &args) {
  ...
  res1 = SWIG_ConvertPtr(args[0], &argp1,SWIGTYPE_p_ps_nbest_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static void _wrap_SegmentIterator_ptr_set(v8::Local<v8::String> property, v8::Local<v8::Value> value,
  const SwigV8PropertyCallbackInfoVoid &info) {
  SWIGV8_HANDLESCOPE();
  ...
  res1 = SWIG_ConvertPtr(info.Holder(), &argp1,SWIGTYPE_p_SegmentIterator, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  res2 = SWIG_ConvertPtr(value, &argp2,SWIGTYPE_p_ps_seg_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_SegmentIterator_ptr_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  ...
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ps_seg_t, 0 |  0 );
...
static void _wrap_NBestIterator_ptr_set(v8::Local<v8::String> property, v8::Local<v8::Value> value,
  const SwigV8PropertyCallbackInfoVoid &info) {
  SWIGV8_HANDLESCOPE();
  ...
  res1 = SWIG_ConvertPtr(info.Holder(), &argp1,SWIGTYPE_p_NBestIterator, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  res2 = SWIG_ConvertPtr(value, &argp2,SWIGTYPE_p_ps_nbest_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res2)) {
...
static SwigV8ReturnValue _wrap_NBestIterator_ptr_get(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  ...
  jsresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_ps_nbest_t, 0 |  0 );
...
SWIGV8_AddMemberVariable(_exports_SegmentIterator_class, "ptr", _wrap_SegmentIterator_ptr_get, _wrap_SegmentIterator_ptr_set);
SWIGV8_AddMemberFunction(_exports_SegmentIterator_class, "next", _wrap_SegmentIterator_next);
SWIGV8_AddMemberVariable(_exports_NBestIterator_class, "ptr", _wrap_NBestIterator_ptr_get, _wrap_NBestIterator_ptr_set);
